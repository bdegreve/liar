...
/** @class liar::shaders::MicrofacetBeckmann
 *  @brief Beckmann Microfacet Distribution
 *
 *  @author Bram de Greve [Bramz]
 */

#ifndef LIAR_GUARDIAN_OF_INCLUSION_SHADERS_MICROFACET_BECKMANN_H
#define LIAR_GUARDIAN_OF_INCLUSION_SHADERS_MICROFACET_BECKMANN_H
...
class LIAR_SHADERS_DLL MicrofacetBeckmann: public MicrofacetDistribution
{
	PY_HEADER(MicrofacetDistribution)
public:

	MicrofacetBeckmann() = default;
