...
/** @class liar::IccSpace
 *  @brief colour space using ICC profiles.
 *  @author Bram de Greve [Bramz]
 */

#ifndef LIAR_GUARDIAN_OF_INCLUSION_KERNEL_ICC_SPACE_H
#define LIAR_GUARDIAN_OF_INCLUSION_KERNEL_ICC_SPACE_H
...
class IccSpace;
typedef python::PyObjectPtr<IccSpace>::Type TIccSpacePtr;

class LIAR_KERNEL_DLL IccSpace: public python::PyObjectPlus, util::NonCopyable
{
