...
PY_DECLARE_CLASS_NAME_DOC(PySpectral, "Spectral", "Represents spectral data")
PY_CLASS_CONSTRUCTOR_0(PySpectral)
PY_CLASS_CONSTRUCTOR_1(PySpectral, Spectral::TValue)
PY_CLASS_CONSTRUCTOR_1(PySpectral, const XYZ&)
PY_CLASS_CONVERTOR(PySpectral, XYZ)
...
Spectral::Spectral(const XYZ& xyz)
{
...
TRgbSpacePtr Spectral::initData()
{
...
XYZ Spectral::observer_[Spectral::numBands] = {};
TWavelength Spectral::bands_[Spectral::numBands + 1] = {};
Spectral Spectral::yellow_;
Spectral Spectral::magenta_;
Spectral Spectral::cyan_;
Spectral Spectral::red_;
Spectral Spectral::green_;
Spectral Spectral::blue_;
TRgbSpacePtr Spectral::rgbSpace_ = Spectral::initData(); // must be the last one.
