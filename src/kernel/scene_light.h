...
public:
	...
	const TSpectrum sampleRadiance(const TVector2D& iSample, const TPoint3D& iDestination, 
...
private:
	...
	virtual const TSpectrum doSampleRadiance(const TVector2D& iSample, const TPoint3D& iDestination,
