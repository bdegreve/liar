...
/** @class liar::textures::Exp
 *  @brief exponential value of texture
 *	@author Bram de Greve (bramz@users.sourceforge.net)
 */

#ifndef LIAR_GUARDIAN_OF_INCLUSION_EXP_H
#define LIAR_GUARDIAN_OF_INCLUSION_EXP_H
...
class LIAR_TEXTURES_DLL Exp: public UnaryOperator
{
	PY_HEADER(UnaryOperator)
public:

	Exp(const TTexturePtr& texture);
