...
/** @class liar::textures::Sqrt
 *  @brief square value of texture
 *	@author Bram de Greve (bramz@users.sourceforge.net)
 */

#ifndef LIAR_GUARDIAN_OF_INCLUSION_SQRT_H
#define LIAR_GUARDIAN_OF_INCLUSION_SQRT_H
...
class LIAR_TEXTURES_DLL Sqrt: public UnaryOperator
{
	PY_HEADER(UnaryOperator)
public:

	Sqrt(const TTextureRef& texture);
