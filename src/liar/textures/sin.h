 ...
 */
 ...
 /** @class liar::textures::Sin
  *  @brief Sine of texture
  *	@author Bram de Greve (bramz@users.sourceforge.net)
  */

#ifndef LIAR_GUARDIAN_OF_INCLUSION_SIN_H
#define LIAR_GUARDIAN_OF_INCLUSION_SIN_H
...
class LIAR_TEXTURES_DLL Sin: public UnaryOperator
{
    PY_HEADER(UnaryOperator)
public:

    Sin(const TTexturePtr& texture);
