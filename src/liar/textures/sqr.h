...
/** @class liar::textures::Sqr
 *  @brief square value of texture
 *	@author Bram de Greve (bramz@users.sourceforge.net)
 */

#ifndef LIAR_GUARDIAN_OF_INCLUSION_SQR_H
#define LIAR_GUARDIAN_OF_INCLUSION_SQR_H
...
class LIAR_TEXTURES_DLL Sqr: public UnaryOperator
{
	PY_HEADER(UnaryOperator)
public:

	Sqr(const TTexturePtr& texture);
