...
/** @class liar::textures::Scale
 *  @brief scales value of texture by a constant
 *	@author Bram de Greve (bramz@users.sourceforge.net)
 */

#ifndef LIAR_GUARDIAN_OF_INCLUSION_SCALE_H
#define LIAR_GUARDIAN_OF_INCLUSION_SCALE_H
...
class LIAR_TEXTURES_DLL Scale: public UnaryOperator
{
