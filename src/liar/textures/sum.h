...
/** @class liar::textures::Sum
 *  @brief sums two or more textures ...
 *	@author Bram de Greve (bramz@users.sourceforge.net)
 */

#ifndef LIAR_GUARDIAN_OF_INCLUSION_TEXTURES_SUM_H
#define LIAR_GUARDIAN_OF_INCLUSION_TEXTURES_SUM_H
...
class LIAR_TEXTURES_DLL Sum: public Texture
{
	PY_HEADER(Texture)
public:

	typedef std::vector<TTextureRef> TTerms;

	Sum();
	explicit Sum(const TTerms& terms);
	Sum(const TTextureRef& a, const TTextureRef& b);
