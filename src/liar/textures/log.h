...
/** @class liar::textures::Log
 *  @brief logarithmic value of texture
 *	@author Bram de Greve (bramz@users.sourceforge.net)
 */

#ifndef LIAR_GUARDIAN_OF_INCLUSION_LOG_H
#define LIAR_GUARDIAN_OF_INCLUSION_LOG_H
...
class LIAR_TEXTURES_DLL Log: public UnaryOperator
{
	PY_HEADER(UnaryOperator)
public:

	Log(const TTexturePtr& texture);
