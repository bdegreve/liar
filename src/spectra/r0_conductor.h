...
public:
	...
	R0Conductor(const TSpectrumPtr& n, const TSpectrumPtr& k);

	const TSpectrumPtr& n() const;
	const TSpectrumPtr& k() const;
	void setN(const TSpectrumPtr& n);
	void setK(const TSpectrumPtr& k);
