...
#ifndef LIAR_GUARDIAN_OF_INCLUSION_TEXTURES_DIVISION_H
#define LIAR_GUARDIAN_OF_INCLUSION_TEXTURES_DIVISION_H
...
class LIAR_TEXTURES_DLL Division: public BinaryOperator
{
	PY_HEADER(BinaryOperator)
public:

	Division(const TTexturePtr& a, const TTexturePtr& b);
