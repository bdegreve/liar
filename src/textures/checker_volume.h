...
/** @class liar::textures::CheckerVolume
 *  @brief mixes two textures in 3D checker board style
 *	@author Bram de Greve (bramz@users.sourceforge.net)
 */

#ifndef LIAR_GUARDIAN_OF_INCLUSION_TEXTURES_CHECKER_VOLUME_H
...
class LIAR_TEXTURES_DLL CheckerVolume: public kernel::Texture
{
