...
config_name = os.path.join(dir_name, "src", "config.h")
...
if __name__ == "__main__":
	...
	parser = OptionParser()
	parser.add_option("-E", "--enforce-existance", action="store_true", dest="enforce_existance", help="create src/config.h iff it does not exist")
