...
def main(num_bands, min_wavelength_nm, max_wavelength_nm, rgbSpaceName, niter=10000, fitall=False):
    ...
    white, yellow, magenta, cyan, red, green, blue = generate_base_spectra(rgb_observer, niter, fitall)
...
def get_rgb_space(name):
    ...
    return liar.RgbSpace(rgb_space.red, rgb_space.green, rgb_space.blue, (1./3, 1./3), 1.)
...
def write_code_fragments(bands, rgb_space, niter, fitall, A, white, yellow, magenta, cyan, red, green, blue):
...
if __name__ == "__main__":
    ...
    main(args.num_bands, args.w_min, args.w_max, args.rgb_space, args.niter, args.fit_all)
